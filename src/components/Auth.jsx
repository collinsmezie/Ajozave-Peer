...
//               <FontAwesomeIcon icon={faEye} className="text-l text-gray-400" />
//             </button>
//           </div>
//         </>
//       ) : (
...
//       {!isExistingCustomer ? (
//         <button className="w-full py-3 border border-gray-300 text-black rounded-lg mb-4"
...
//       {/* Google button */}
//       <button
//         className="w-full py-3 bg-red-500 text-white rounded-lg flex items-center justify-center mb-4"
  ...
  return (
    <div className="fixed w-full h-full max-w-sm p-4 overflow-hidden border-2 border-gray-200 rounded-lg shadow-lg">
      ...
      <div className="flex space-x-2">
        <button
          className="flex-1 py-3 bg-red-500 text-white rounded-lg flex items-center justify-center"
          onClick={() => loginWithRedirect({ connection: 'google' })}
        >
          <FontAwesomeIcon icon={faGoogle} className="mr-2" />
          Google
        ...
        <button
          className="flex-1 py-3 bg-blue-600 text-white rounded-lg flex items-center justify-center"
          onClick={() => loginWithRedirect({ connection: 'facebook' })}
        >
          <FontAwesomeIcon icon={faFacebook} className="mr-2" />
          Facebook
